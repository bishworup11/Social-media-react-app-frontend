...
const FeedComponent = () => {
  ...
  function handlePost() {
    if (postText === "") {
      alert("Please enter a text to post");
      return;
    }
      ...
      <div className="_feed_inner_text_area_box">
        ...
        <div className="form-floating _feed_inner_text_area_box_form ">
          <textarea
            ...
            id="floatingTextarea"
            value={postText}
            onChange={(e) => setPostText(e.target.value.trimStart())}
          ></textarea>
      ...
      <div className="_feed_inner_text_area_bottom">
        <div className="_feed_inner_text_area_item">
          <div className="_feed_inner_text_area_bottom_photo _feed_common">
            ...
            >
              <label className="_feed_inner_text_area_bottom_photo_image _mar_img">
        ...
        <div className="_feed_inner_text_area_btn" onClick={() => handlePost()}>
